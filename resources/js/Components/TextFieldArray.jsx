    ...
    return (
        <>
            <div className="flex gap-3 items-center mt-3">
                ...
                <button
                    type="button"
                    className="cursor-pointer focus:outline-none focus:ring-primary-400 focus:ring-2 bg-green px-2 py-px w-fit rounded-lg text-tan font-bold hover:bg-green-400"
                    onClick={() => append("")}
                >
                    + Add
                </button>
