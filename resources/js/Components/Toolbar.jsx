...
function Toolbar({ onQueryChange, query, onCreate }) {
    return (
        <div className="pb-6 flex gap-3 flex-wrap">
            <div className="bg-gray flex items-center px-3 rounded-lg shadow-md">
                <FontAwesomeIcon
            ...
            <button
                onClick={onCreate}
                className="bg-green text-tan px-2 py-1 flex gap-2 items-center rounded-lg group/button font-bold uppercase hover:bg-green-400"
            >
                <FontAwesomeIcon
